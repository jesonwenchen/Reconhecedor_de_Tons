...
model = tf.keras.models.load_model('modelo_classificador_tons.keras')
X_test = np.load('features_X.npy') # Vamos usar todos os dados para ter uma visão geral
y_test = np.load('labels_y.npy')
